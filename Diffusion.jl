...
# ╔═╡ deebf144-8f5c-4b42-9bb2-6840c9c17ef9
begin
	using OffsetArrays
	using Images
end

# ╔═╡ f996528a-e89e-11eb-141b-89fb0e9b4df6
md"""
...
# ╔═╡ 651938ec-2957-41ce-96f0-012ea6612d03
Base.Broadcast.BroadcastStyle(::Type{<:OffsetArray{<:Any, <:Any, AA}}) where AA = Base.Broadcast.BroadcastStyle(AA)

# ╔═╡ cf8f5156-e26c-4f03-bd61-43bd0ff5b6c4
begin
	dx = 0.01  # x-grid spacing
	dy = 0.01  # y-grid spacing
end

# ╔═╡ a8fc6dca-25ec-46c9-8f7c-dbb8236577c5
@bind a  html"<input type='range' min='0.0' max='1' step='0.001' value='0.01'>"

# ╔═╡ 686412bf-098a-4fb4-ba95-8da34af8b278
dt = dx^2 * dy^2 / (2.0 * a * (dx^2 + dy^2)) # Largest stable time step

# ╔═╡ 25cee909-81ad-4f3e-bd86-ff65008b3abc
N = 64

# ╔═╡ 1a603675-3e94-4008-98e1-ba17cf182867
...
# ╔═╡ ae5c47d1-d4c5-4042-8a03-e68c39728406
@bind T html"<input type='range' min='0' max='1000' step='1' value='10'>"

# ╔═╡ 24466ddf-0c06-499e-923b-8ea09978189c
begin
...
# ╔═╡ 4755c335-c6a6-48f2-9b72-5375196daab3
